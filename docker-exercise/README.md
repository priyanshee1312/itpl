...
2. clone this repo. into your local system using following command
```
git clone https://git.pride.improwised.dev/Onboarding-2024/Utsav-Adhyaru.git
```        
3. build docker image using following command
```   
    docker build -t pro1:1.0 .
```
this LOC will build your image 

4. run docker-compose with following command
```
    docker-compose up
```
5. stopping compose 
